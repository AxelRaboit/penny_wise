...
export function initializeWalletListModals() {
  attachModalEvents({
    ...
    modalMessage:
      'This action will also delete all of the wallets and transactions associated with this account.',
  ...
  attachModalEvents({
    ...
    modalMessage:
      'This action will also delete all of the transactions associated with this month.',
  ...
  attachModalEvents({
    ...
    modalMessage:
      'This action will also delete all of the months and transactions associated with this year.',
