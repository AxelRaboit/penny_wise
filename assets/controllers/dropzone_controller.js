...
export default class extends Controller {
    connect() {
        this.element.addEventListener('dropzone:connect', this._onConnect.bind(this));
    ...
    _onChange(event) {
        ...
        if (!successText) {
            ...
            successText.classList.add('success-message', 'text-success', 'absolute', 'top-0', 'left-0', 'ml-2', 'mt-2');
