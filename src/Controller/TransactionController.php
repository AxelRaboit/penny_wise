...
{
    public function __construct(private readonly EntityManagerInterface $entityManager, private readonly BudgetService $budgetService){}
    ...
    public function newSubmission(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            try {
                ...
                $this->budgetService->setRemainingBalance($transaction);
                if ($request->isXmlHttpRequest()) {
