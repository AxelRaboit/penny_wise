...
final readonly class WalletManager
{
    ...
    public function __construct(private EntityManagerInterface $entityManager, private TransactionManager $transactionManager, private WalletRepository $walletRepository) {}
     ...
     * @param Account   $account       the account to link to the new wallet
     *
